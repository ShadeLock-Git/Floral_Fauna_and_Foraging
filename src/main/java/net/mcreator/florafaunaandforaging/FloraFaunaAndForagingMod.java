 ...
 *
 */
package net.mcreator.florafaunaandforaging;
...
import net.mcreator.florafaunaandforaging.init.FloraFaunaAndForagingModBlockEntities;
...
@Mod("flora_fauna_and_foraging")
public class FloraFaunaAndForagingMod {
	public static final Logger LOGGER = LogManager.getLogger(FloraFaunaAndForagingMod.class);
	public static final String MODID = "flora_fauna_and_foraging";

	public FloraFaunaAndForagingMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		FloraFaunaAndForagingModBlocks.REGISTRY.register(bus);
		FloraFaunaAndForagingModBlockEntities.REGISTRY.register(bus);
		...
		FloraFaunaAndForagingModParticleTypes.REGISTRY.register(bus);
